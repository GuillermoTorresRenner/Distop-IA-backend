...
async function seedAttributes() {
    const items = (0, vault_loader_1.loadAttributes)();
...
async function seedAbilities() {
    const items = (0, vault_loader_1.loadAbilities)();
    for (let i = 0; i < items.length; i++) {
        const a = items[i];
...
async function seedHealthLevels() {
    const items = (0, vault_loader_1.loadHealthLevels)();
    for (let i = 0; i < items.length; i++) {
        const h = items[i];
...
async function seedArchetypes() {
    const items = (0, vault_loader_1.loadArchetypes)();
    for (let i = 0; i < items.length; i++) {
        const a = items[i];
...
async function seedMeritsFlaws() {
    const items = (0, vault_loader_1.loadMeritsFlaws)();
    for (let i = 0; i < items.length; i++) {
        const m = items[i];
...
async function main() {
    ...
    const abilities = (0, vault_loader_1.loadAbilities)();
